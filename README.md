...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-26 14:46`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d79a2f1d-f38b-4aa0-a302-35b4a405004a.git
$ cd d79a2f1d-f38b-4aa0-a302-35b4a405004a
```
